...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'geochat' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                model = GeoChatLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, ignore_mismatched_sizes=True, **kwargs)
    else:
        # Load language model
    ...
    if 'geochat' in model_name.lower():
        ...
        # SAR encoder doesn't have image_processor like CLIP
        if hasattr(vision_tower, 'image_processor'):
            image_processor = vision_tower.image_processor
        else:
            # For SAR encoder, create a dummy processor or None
            image_processor = None
